...
class Signal
{
     ...
     * @ORM\Column(type="string", length=100)
     */
    private $account_meta_id;

    /**
     * @ORM\ManyToOne(targetEntity=Account::class, inversedBy="signals")
     * @ORM\JoinColumn(nullable=false)
     */
    private $account;
     ...
     * @return mixed
     */
    public function getAccountMetaId()
    {
        return $this->account_meta_id;
    }

    /**
     * @param mixed $account_meta_id
     */
    public function setAccountMetaId($account_meta_id): void
    {
        $this->account_meta_id = $account_meta_id;
    }
