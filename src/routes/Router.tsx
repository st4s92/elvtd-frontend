...
import Users from 'src/views/dashboards/Users/Index';
import Signals from 'src/views/dashboards/Signals/Index';
import Accounts from 'src/views/dashboards/Accounts/Index';
