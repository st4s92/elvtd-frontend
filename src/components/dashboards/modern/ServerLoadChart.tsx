                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-sm font-semibold text-white">{server.server_name || server.serverName || '-'}</div>
                                    <div className="text-xs text-gray-500">{server.server_ip || server.serverIp || '-'}</div>
                                </div>
                                <span
